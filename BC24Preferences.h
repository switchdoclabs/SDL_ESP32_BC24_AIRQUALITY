...
void writePreferences()
{
  ...
  preferences.putInt("ClockTimeOffsetToUTC", ClockTimeOffsetToUTC);
  ...
  Serial.printf("ClockTimeOffsetToUTC="); Serial.println(ClockTimeOffsetToUTC);
  Serial.println("--------------------------");
#endif
...
void readPreferences()
{
  ...
  ClockTimeOffsetToUTC = preferences.getInt("ClockTimeOffsetToUTC");
  preferences.end();
